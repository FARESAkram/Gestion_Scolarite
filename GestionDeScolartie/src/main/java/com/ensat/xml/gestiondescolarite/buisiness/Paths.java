...
public abstract class Paths
{
    ...
    public static final String EMPLOIS_EXCELS_PATH = BD_PATH+"/Emploi/XMLFiles" ;
    ...
    public static final String EMPLOIS_XML_PATH = OUTPUT_PATH+"/Emploi/XMLFiles";
    ...
    //XSLT FILES PATHS;
    public static final String XSLT_FILES_DIRECTORY = "XSLTs";
    public static final String STUDENTS_XSLT_PATH = XML_UTILS_PATH+"/"+XSLT_FILES_DIRECTORY;
    public static final String MATIERES_XSLT_PATH = XML_UTILS_PATH+"/"+XSLT_FILES_DIRECTORY ;
    public static final String PROFS_XSLT_PATH = XML_UTILS_PATH+"/"+XSLT_FILES_DIRECTORY ;
    public static final String NOTES_XSLT_PATH = XML_UTILS_PATH+"/"+XSLT_FILES_DIRECTORY;
    public static final String MODULES_XSLT_PATH = XML_UTILS_PATH+"/"+XSLT_FILES_DIRECTORY;

    //XQUERY FILES PATHS
    public static final String XQUERY_FILES_DIRECTORY = "XQUERYs";
    public static final String STUDENTS_XQUERY_PATH = XML_UTILS_PATH+"/"+XQUERY_FILES_DIRECTORY;
    public static final String MATIERES_XQUERY_PATH = XML_UTILS_PATH+"/"+XQUERY_FILES_DIRECTORY ;
    public static final String PROFS_XQUERY_PATH = XML_UTILS_PATH+"/"+XQUERY_FILES_DIRECTORY ;
    public static final String NOTES_XQUERY_PATH = XML_UTILS_PATH+"/"+XQUERY_FILES_DIRECTORY;
    public static final String MODULES_XQUERY_PATH = XML_UTILS_PATH+"/"+XQUERY_FILES_DIRECTORY;
