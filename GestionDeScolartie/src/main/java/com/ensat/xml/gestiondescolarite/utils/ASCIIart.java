...
public class ASCIIart {
    ...
    public static void write(String word)
    {
        ...
        BufferedImage image = new BufferedImage(200, 16, BufferedImage.TYPE_INT_RGB);
    ...
    public static void alertSuccess(String message){
        System.out.println(ASCIIart.GREEN_BOLD_BRIGHT+message+ASCIIart.RESET);
    }

    public static void alertFailure(String message){
        System.out.println(ASCIIart.RED_BOLD_BRIGHT+message+ASCIIart.RESET);
    }
}
